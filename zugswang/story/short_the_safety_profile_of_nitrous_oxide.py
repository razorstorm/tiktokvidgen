...
def get_scene(name: str, text: str, media_filepath: str):
    narration = get_narration(text)
    return Scene(name=name, narration=narration, media_filepath=media_filepath)
...
scene = Scene(
    ...
    """),
    media_filepath="https://images.squarespace-cdn.com/content/v1/64b1beb639c2942d73a49116/42901218-8dfc-4af1-bdeb-158322dfedfb/file-5NKAalokMFMah4u93orNL5bL.png?format=1500w",
)
scenes.append(scene)
...
scene = Scene(
    ...
    """),
    media_filepath="https://images.squarespace-cdn.com/content/v1/64b1beb639c2942d73a49116/1fd89997-3a34-4f06-8c7b-872aa05dc954/olneyslesions.jpg?format=1500w",
)
scenes.append(scene)
...
scene = Scene(
    ...
    """),
    media_filepath="https://images.squarespace-cdn.com/content/v1/64b1beb639c2942d73a49116/dc7e621a-7726-4593-99e7-e63b20f796a4/Cobalamin_skeletal.svg.png?format=1500w",
)
scenes.append(scene)
...
scene = Scene(
    ...
    """),
    media_filepath="https://images.squarespace-cdn.com/content/v1/64b1beb639c2942d73a49116/6a75c11d-2b39-4f45-9503-bc1065bfb71c/NOS_Cracker_With_Balloon_And_Charger.jpg?format=1500w",
)
scenes.append(scene)
...
scene = Scene(
    name='Other drugs in the "safe inhalants" list include:',
    narration=get_narration("""
    ...
    """),
    media_filepath="https://images.squarespace-cdn.com/content/v1/64b1beb639c2942d73a49116/d58e6f10-07e7-42a1-baef-c9db87a2c0fc/file-fL7hQtdcqXstqYAdxEujB48Z.png?format=1500w",
)
scenes.append(scene)
...
if __name__ == '__main__':
    ...
    # generate_images(scenes, output_dir)
